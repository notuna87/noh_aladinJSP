		...
		<div id="boarderWrap">
			...
			<div class="border">
				<div class="borderForm">
					<input type="hidden" value="${board.num}" name="num"> <input
						type="hidden" name="nonmakeImg" value="${board.pictureUrl}">
					...
					<input type="file" name="pictureUrl"><br> <span>(이미지
						수정을 원하시는 고객님만 클릭해주세요.)</span>
				</div>
			</div>
		</div>
		<div class="ButtonWrap">
			<input class="submitButton" type="submit" value="수정하기" onclick="return confirm('정말 수정하시겠습니까?');"> <input
